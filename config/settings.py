...
MIDDLEWARE = [
    ...
    # Sirve los estaticos desde el propio proceso: sin nginx aparte, que para un
    # despliegue chico es una pieza menos que mantener.
...
# Endurecimiento cuando DEBUG esta apagado (seccion 13 bis).
if not DEBUG:
    SECURE_PROXY_SSL_HEADER = ("HTTP_X_FORWARDED_PROTO", "https")
    SECURE_SSL_REDIRECT = env_bool("DJANGO_SECURE_SSL_REDIRECT", True)
    SESSION_COOKIE_SECURE = True
    CSRF_COOKIE_SECURE = True
    SECURE_HSTS_SECONDS = int(os.getenv("DJANGO_HSTS_SEGUNDOS", "31536000"))
